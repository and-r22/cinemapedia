class MovieMovieDB {
    ...
    factory MovieMovieDB.fromJson(Map<String, dynamic> json) => MovieMovieDB(
      ...
      releaseDate: json['release_date'] != null 
          ? DateTime.tryParse(json['release_date'] as String) ?? DateTime(1970, 1, 1) // Manejo de fechas inválidas
          : DateTime(1970, 1, 1), // Si es null, asignamos una fecha predeterminada
